  ...
  const printContent = `
    ...
    <body>
      <div class="header">
        ...
        <p><strong>${companyName}</strong> â€¢ ${dateRangeLabel} â€¢ Generated ${new Date().toLocaleDateString()}</p>
      </div>
      ...
      <div class="section">
        ...
        <div class="two-col">
          <div class="card">
            <div class="card-title">ðŸ“Š Engagement Breakdown</div>
            ${generateEngagementPieHTML()}
          </div>
          <div class="card">
            <div class="card-title">ðŸ“ˆ Platform Distribution</div>
      ...
      <div class="section">
        ...
        <div class="two-col">
          ...
          <div class="card">
            <div class="card-title">ðŸ“… Performance by Day</div>
            ${generateHeatmapHTML()}
          </div>
        </div>
      </div>
        ...
        ${topPosts.slice(0, 5).map((post, idx) => `
          <div class="top-post">
            ...
            <div class="metrics">
              ...
              <span>ðŸ’¬ ${post.metrics?.comments || 0}</span>
              <span>ðŸ”„ ${post.metrics?.shares || 0}</span>
              <span>ðŸ“Š ${post.metrics?.engagementRate?.toFixed(2) || 0}% rate</span>
            </div>
          </div>
        `).join('')}
      </div>
      ...
      <div class="section">
        ...
        <div class="two-col">
          <div class="insight-box">
            <div class="insight-title">ðŸ’¡ Key Findings</div>
            <ul class="insight-list">
              ${aiInsights.keyFindings.map(f => `<li>${f}</li>`).join('')}
            </ul>
          </div>
          <div class="insight-box">
            <div class="insight-title">âš¡ Recommendations</div>
            <ul class="insight-list">
        ...
        <div class="two-col" style="margin-top: 15px;">
          ...
          <div class="insight-box">
            <div class="insight-title">ðŸ“ Content Tips</div>
            <ul class="insight-list">
          ...
          <div class="insight-box">
            <div class="insight-title">â° Timing Advice</div>
      ...
      <div class="footer">
        Generated by RoboSocial CMS â€¢ ${new Date().toLocaleString()}
      </div>
    </body>
    </html>
  `;
